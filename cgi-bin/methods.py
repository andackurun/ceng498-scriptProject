...
class Point2D:
	...
	def show(self):
		...
		return "<x>"+str(self.x)+"</x>"+"<y>"+str(self.y)+"</y>"
...
class Triangle(Line,Point2D):
	...
	def __repr__(self):
		...
		return '<triangle>'+'<pointA>'+self.a.show()+'</pointA>'+'<pointB>'+self.b.show()+'</pointB>'+'<pointC>'+self.c.show()+'</pointC>'+'</triangle>'
class Rectangle(Point2D):
	...
	def __repr__(self):
		...
		return '<rectangle>'+'<startPos>'+self.startPos.show()+'</startPos>'+'<width>'+str(self.width)+'</width>'+'<height>'+str(self.height)+'</height>'+'<color>'+'<r>'+str(self.color[0])+'</r>'+'<g>'+str(self.color[1])+'</g>'+'<b>'+str(self.color[2])+'</b>'+'</color>'+'</rectangle>'
...
#		pygame.display.flip()
	...
	def __repr__(self):
		...
		return '<square>'+'<startPos>'+self.startPos.show()+'</startPos>'+'<width>'+str(self.width)+'</width>'+'<height>'+str(self.height)+'</height>'+'<color>'+'<r>'+str(self.color[0])+'</r>'+'<g>'+str(self.color[1])+'</g>'+'<b>'+str(self.color[2])+'</b>'+'</color>'+'</square>'
class Circle(Point2D):
	...
	def __repr__(self):
		...
		return '<circle>'+'<startPos>'+self.startPos.show()+'</startPos>'+'<radius>'+str(self.radius)+'</radius>'+'<color>'+'<r>'+str(self.color[0])+'</r>'+'<g>'+str(self.color[1])+'</g>'+'<b>'+str(self.color[2])+'</b>'+'</color>'+'</circle>'
class Text():
	...
	def __repr__(self):
		#return self.string
		return '<text>'+'<startPos>'+self.startPos.show()+'</startPos>'+'<string>'+str(self.string)+'</string>'+'<size>'+str(self.size)+'</size>'+'<font>'+str(self.font)+'</font>'+'</text>'
